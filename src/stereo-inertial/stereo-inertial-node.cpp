    ...
    SLAM_(SLAM)
{
    ...
    subImgLeft_ = this->create_subscription<ImageMsg>("left/image_raw", 100, std::bind(&StereoInertialNode::GrabImageLeft, this, _1));
    subImgRight_ = this->create_subscription<ImageMsg>("right/image_raw", 100, std::bind(&StereoInertialNode::GrabImageRight, this, _1));
